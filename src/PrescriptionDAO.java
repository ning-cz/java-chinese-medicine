 ...
 */
public class PrescriptionDAO implements GenericDAO<Prescription>{
    // 修改数据库连接配置
    ...
    public List<Prescription> getAllPrescriptions() {
        ...
        String sql = "SELECT name, from, composition, efficiency, therapy, usage, taboo FROM prescriptions";
